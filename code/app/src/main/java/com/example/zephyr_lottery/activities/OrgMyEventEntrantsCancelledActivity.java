...
public class OrgMyEventEntrantsCancelledActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            if(value != null && !value.isEmpty()){
                ...
                for (QueryDocumentSnapshot snapshot : value){
                    ...
                    if (snapshot.getId().equals(Integer.toString(getIntent().getIntExtra("EVENT_CLICKED_CODE", -1)))) {
                        ...
                        entrantArrayList = (ArrayList<String>) snapshot.get("rejected_entrants");
                        ...
                        nameArrayAdapter = new ArrayAdapter<String>(this, R.layout.org_my_event_entrantslist_cancelled_activity, R.id.entrants_cancelled_item, entrantArrayList);
        ...
        findViewById(R.id.button_noti_cancelled).setOnClickListener(new View.OnClickListener() {
            @Override
                    ...
                    entrant.get().addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                if (profile != null) {
                                    entrant.update("pendingNotifs", FieldValue.arrayUnion("You've cancelled " + event.getName() + "//" + event.getDescription()));
                                }
                            }
                        }
                    });
